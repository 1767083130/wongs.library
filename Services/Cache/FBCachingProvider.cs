...
namespace Wongs.Services.Cache
{
    public class FBCachingProvider : CachingProvider
    {
        ...
        public override string PurgeCache()
        {
            ...
            return PurgeCacheFiles(Globals.ApplicationMapPath + CachingDirectory);
        }
        ...
        private static string GetFileName(string CacheKey)
        {
            ...
            return Path.GetFullPath(Globals.ApplicationMapPath + CachingDirectory + FinalFileName + CacheFileExtension);
        }
